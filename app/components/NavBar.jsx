...
<motion.div initial="hidden" animate="visible" variants={{
  ...
  items-center justify-between w-full " id="navbar-sticky`}>
    <ul className="flex flex-col font-medium  bg-neutral-800">
      ...
      <li>
        <a href="https://drive.google.com/file/d/18dqgyRL6iE9MnqMFRL8GbWukI0ob7MyJ/view?usp=sharing" className="block py-2 pl-3 pr-4 rounded   hover:bg-white/[.1] rounded" target="_blank" rel="noopener noreferrer">Resume</a>
      </li>
